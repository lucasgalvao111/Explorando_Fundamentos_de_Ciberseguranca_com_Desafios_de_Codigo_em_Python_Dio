# Primeiro desafio proposto do bootcamp Santander / Simulação de Enumeração de Serviços em um Servidor
...
def main():
    print("Por favor, escreva os números das portas separados por vírgula. Exemplo: 22, 80, 443")
    ports_input = input("Digite os números das portas: ")
    ...
    print("Serviços correspondentes às portas fornecidas:")
    print(services)
